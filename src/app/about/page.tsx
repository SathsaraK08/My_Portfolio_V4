        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <SlideInRight className="space-y-6">
              ...
              <FadeIn delay={0.3}>
                <HoverScale>
                  <div className="mx-auto w-80 h-80 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50 rounded-2xl flex items-center justify-center border border-blue-200/50 dark:border-blue-800/50 shadow-lg">
                  ...
                  <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-blue-200/50 dark:border-blue-800/50 shadow-lg">
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center space-x-3 group">
                        ...
                        <span className="group-hover:text-blue-600 transition-colors">San Francisco, CA</span>
                      </div>
                      <div className="flex items-center space-x-3 group">
                        <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                          <Mail className="h-4 w-4 text-white" />
                        </div>
                        <span className="group-hover:text-blue-600 transition-colors">john.doe@example.com</span>
                      </div>
                      <div className="flex items-center space-x-3 group">
                        <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
