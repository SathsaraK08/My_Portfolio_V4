      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-12 leading-relaxed">
            I believe in lifelong learning and staying up-to-date with the latest 
            technologies and industry best practices.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Badge className="text-sm px-6 py-3 bg-white/20 backdrop-blur-sm text-white border border-white/30">
              Currently studying: Advanced ML Algorithms
            </Badge>
            <Badge className="text-sm px-6 py-3 bg-white/20 backdrop-blur-sm text-white border border-white/30">
              Next goal: Kubernetes Expert Certification
            </Badge>
          </div>
        </div>
      </section>
