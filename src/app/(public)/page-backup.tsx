    ...
    <div className="flex flex-col">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 space-y-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Project placeholders - these will be replaced with dynamic data */}
          <ScrollReveal direction="up" delay={0.1}>
            <HoverGlow>
              <ParallaxScroll offset={20}>
                <Card className="group hover:shadow-lg transition-all duration-300 h-full hover:-translate-y-2">
                  <CardHeader>
                    <div className="h-48 bg-gradient-to-br from-blue-100 to-purple-200 dark:from-blue-900 dark:to-purple-800 rounded-md mb-4 flex items-center justify-center overflow-hidden relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20"></div>
                      <span className="text-muted-foreground relative z-10">🛒 E-Commerce</span>
                    </div>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">React</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">Next.js</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">Stripe</span>
                    </div>
              ...
              <ParallaxScroll offset={30}>
                <Card className="group hover:shadow-lg transition-all duration-300 h-full hover:-translate-y-2">
                  <CardHeader>
                    <div className="h-48 bg-gradient-to-br from-blue-100 to-purple-200 dark:from-blue-900 dark:to-purple-800 rounded-md mb-4 flex items-center justify-center overflow-hidden relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20"></div>
                      <span className="text-muted-foreground relative z-10">📋 Task Manager</span>
                    </div>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">React</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">Socket.io</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">MongoDB</span>
                    </div>
                    <Button variant="outline" size="sm" asChild className="group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                      <Link href="/projects">View Project</Link>
                    </Button>
              ...
              <ParallaxScroll offset={15}>
                <Card className="group hover:shadow-lg transition-all duration-300 h-full hover:-translate-y-2">
                  <CardHeader>
                    <div className="h-48 bg-gradient-to-br from-blue-100 to-purple-200 dark:from-blue-900 dark:to-purple-800 rounded-md mb-4 flex items-center justify-center overflow-hidden relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20"></div>
                      <span className="text-muted-foreground relative z-10">🌤️ Weather App</span>
                    </div>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">Vue.js</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">API</span>
                      <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 px-2 py-1 rounded-full">Charts</span>
                    </div>
                    <Button variant="outline" size="sm" asChild className="group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                      <Link href="/projects">View Project</Link>
                    </Button>
